...
<table class="form-table" id="category_images_ii">
	<?php if ( $term_image ) { ?>
		<tr class="form-field current-category-image">
			<th scope="row" valign="top"><?php _e( 'Current Image', 'category-images-ii' ) ?></th>
			<td>
	...
	<tr class="form-field upload-category-image">
		<th scope="row" valign="top"><label for="category_image_ii"><?php _e( 'Upload an image', 'category-images-ii' ) ?></label></th>
		<td>
